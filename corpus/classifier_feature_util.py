...
class FunctionWords:
    ...
    deu_function_words = _D_auxiliaries + _D_article + _D_pronouns + _D_prepositions + _D_conjunction + _D_questionwords + _D_particles + _D_timeplace
    ...
    _E_auxiliaries = ["have", "has", "had",
                      ...
                      "will","would"]
    eng_function_words = _E_auxiliaries + _E_article + _E_pronouns + _E_prepositions + _E_conjunction + _E_questionwords + _E_particles + _E_adverbs
