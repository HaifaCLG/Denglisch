...
# This main() gets called at the end of the file. This way we can keep all the "real" code in one place and can move
# static resources such as word lists to the end of the file.
def main():
